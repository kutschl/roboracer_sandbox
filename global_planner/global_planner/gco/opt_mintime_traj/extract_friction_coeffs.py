...
from .friction_map_interface import FrictionMapInterface
...
def extract_friction_coeffs(reftrack: np.ndarray,
    ...
    map_interface = FrictionMapInterface(tpamap_path=tpamap_path, tpadata_path=tpadata_path)
    ...
    for i in range(num_steps):
        ...
        if print_debug:
            progressbar(i, num_steps, 'Extraction of Friction Coefficients from Friction Map')
